...
# # url = "mysql://root:YHwYuhkYhEKsOuxhDQVcMhemgTMdDbKU@switchback.proxy.rlwy.net:59007/railway"
...
# # # Create a connection (without specifying database yet)
...
# #     host=host,
# #     port=port,
# #     database="railway"  # Specify the database
...
# #         # conn = get_connection()
# #         cursor = conn.cursor()
# #         cursor.execute("INSERT INTO time_slot (user_id, course_id, teacher_id, date_and_time) VALUES (%s, %s, %s, %s)",
